...
int main()
{
    ...
    cant = mostrarLista_MIO(&lista, mostrarMovim, fpPant);
...
/** ordenarLista_MIO(&lista, compararMovim_MIO);                             **/
    ...
    if(cant != mostrarLista_MIO(&lista, mostrarMovim, fpPant))
...
/** cantElim = eliminarMostrarYMostrarSubTot_MIO(&lista, fpPant,
    ...
    cant = vaciarListaYMostrar_MIO(&lista, mostrarMovim, fpPant);
